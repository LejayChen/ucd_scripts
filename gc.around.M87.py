...
gc_density, gc_density_err, bin_mean_gc = gc_density_stat(cat)
...
slope, intercept, r_value = gc_fitting(gc_density, bin_mean_gc, fit_min, fit_max)
...
plt.savefig('pics/gc.around.M87.png')
plt.show()