...
tab_names = ['ID','ra','dec','DIS','r_h']+ str_radius 
tab_dtype = ['a8','f8','f8','f4','f4']+['f4']*len(radius)
...
for i in range(len(cat_ucd)): 
	...
	if dis_M87_ucd>250. or dis_M87_ucd<20.:
		continue
	exp_density = exp(5.3328)*dis_M87_ucd**(-1.9161)   # expected density (assume uniform in the vicinity of a UCD)
	bkg_unif =  0   # uniform bakground in the field (possibly non-GC objects)
